...
for ptBin in range(0,16):
   for etaBin in range(0,14):
		plotHistosStubs(fMB,fDoubleMuGun,"muonQuality_"+str(ptBin)+"_"+str(etaBin),"Quality PT:"+str(ptBin)+", ETA:"+str(etaBin),0.4)
                plotHistosStubs(fMB,fDoubleMuGun,"muonNStubs_"+str(ptBin)+"_"+str(etaBin),"NStubs PT:"+str(ptBin)+", ETA:"+str(etaBin),0.4)
